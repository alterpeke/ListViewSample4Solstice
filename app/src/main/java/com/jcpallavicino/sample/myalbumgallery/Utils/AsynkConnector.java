...
public class AsynkConnector extends AsyncTask<String, String, String> {
    ...
    private final String endpoint = "https://s3.amazonaws.com/technical-challenge/v3/contacts.json";
...
*/
    ...
    private String composeURL(int service, String param) {
        ...
        Log.i("INFO ASYNC", "INICIALIZACION OK");
        String ret = null;
    ...
    public String doConnection(){
        ...
        String ret = null;
        Log.i("INFO ASYNC", "DO CONNECTION");
